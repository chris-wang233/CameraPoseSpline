...
/*             P0=para_factor(0,0)*start_pose+para_factor(0,1)*end_pose+para_factor(0,2)*start_velocity+para_factor(0,3)*end_velocity+para_factor(0,4)*it->second;
            ...
            P0 =para_factor(0,0)*start_pose+para_factor(0,1)*end_pose+para_factor(0,2)*start_velocity+0.01*para_factor(0,3)*end_velocity;
            P1 =para_factor(1,0)*start_pose+para_factor(1,1)*end_pose+para_factor(1,2)*start_velocity+0.01*para_factor(1,3)*end_velocity;
            P2 =para_factor(2,0)*start_pose+para_factor(2,1)*end_pose+para_factor(2,2)*start_velocity+0.01*para_factor(2,3)*end_velocity;
            P3 =para_factor(3,0)*start_pose+para_factor(3,1)*end_pose+para_factor(3,2)*start_velocity+0.01*para_factor(3,3)*end_velocity;
            int i=1;
...
class Spline_Least_Square_muti{
    public:
        ...
        end_velocity(end_velocity_),para_factor(4,4+time_pose.size()+time_velocity.size()){};
...
/*             P0=para_factor(0,0)*start_pose+para_factor(0,1)*end_pose+para_factor(0,2)*start_velocity+para_factor(0,3)*end_velocity+para_factor(0,4)*it->second;
            ...
            P0 =para_factor(0,0)*start_pose+para_factor(0,1)*end_pose+0.01*para_factor(0,2)*start_velocity+para_factor(0,3)*end_velocity*0.01;
            P1 =para_factor(1,0)*start_pose+para_factor(1,1)*end_pose+0.01*para_factor(1,2)*start_velocity+para_factor(1,3)*end_velocity*0.01;
            P2 =para_factor(2,0)*start_pose+para_factor(2,1)*end_pose+0.01*para_factor(2,2)*start_velocity+para_factor(2,3)*end_velocity*0.01;
            P3 =para_factor(3,0)*start_pose+para_factor(3,1)*end_pose+0.01*para_factor(3,2)*start_velocity+para_factor(3,3)*end_velocity*0.01;
